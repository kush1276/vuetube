  ...
  return (
    <nav className="fixed left-0 top-0 h-full w-64 hidden md:block bg-white dark:bg-slate-900 border-r border-slate-100 dark:border-slate-800 flex flex-col pt-14 z-40 transition-colors duration-300">
      <div className="flex-1 overflow-y-auto py-4">
        {/* Navigation Section */}
        <div className="mb-2">
          <a className="flex items-center gap-4 px-6 py-3 bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 font-semibold border-r-4 border-emerald-500 transition-transform active:translate-x-1" href="#">
